...
local MODES = {
 PRO          = {h_base=90,h_ping=.22,h_speed=2,v_base=125,v_ping=.14,v_dist=.18,sim_base=35,sim_speed=.4,int_base=50,int_speed=-.3,offX=-11,offY=-89,offZ=1},
 INSTINCT     = {h_base=90,h_ping=.30,h_speed=2,v_base=140,v_ping=.18,v_dist=.22,sim_base=45,sim_speed=.5,int_base=35,int_speed=-.2,offX=-12,offY=-98,offZ=-1},
...
local ASUB = {
 CLOSE={h_base=92,h_ping=.28,h_speed=1.8,v_base=135,v_ping=.18,v_dist=.22,sim_base=42,sim_speed=.5,int_base=38,int_speed=-5,offX=-18,offY=-92,offZ=-1},
 MID  ={h_base=101,h_ping=.22,h_speed=1.5,v_base=125,v_ping=.14,v_dist=.18,sim_base=35,sim_speed=.4,int_base=50,int_speed=-4,offX=-16,offY=-78,offZ=1},
 SNIP ={h_base=120, h_ping=.10,h_speed=.8, v_base=95, v_ping=.08,v_dist=.10,sim_base=22,sim_speed=.15,int_base=68,int_speed=-5,offX=-12,offY=-89,offZ=0},
 DEF  ={h_base=95,h_ping=.15,h_speed=1.0,v_base=105,v_ping=.10,v_dist=.12,sim_base=28,sim_speed=.2,int_base=60,int_speed=-4,offX=-13,offY=-90,offZ=-1},
}
